...
namespace Project2_EntityFrameworkDbFirstProduct
{
    public partial class FrmProduct : Form
    {
        ...
        private void FrmProduct_Load(object sender, EventArgs e)
        {
            ...
            cmbProductCategory.DisplayMember = "CategoryName"; // combobox'ta gözükecek olan
            cmbProductCategory.ValueMember = "CategoryId"; // datagridview'da gözükecek olan
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            // Entity Framework'te şartlı listeleme işlemi gerçekleştirebilmek için where keywordünü kullanıyoruz.
        }
        ...
        private void btnProductListWithCategory_Click(object sender, EventArgs e)
        {
            var values = db.TblProduct
                ...
                {
                    ProductId = product.ProductId,  // Burada soldaki değer datagridview'da gelecek sütun başlıkları
